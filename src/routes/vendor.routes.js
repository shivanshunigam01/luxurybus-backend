...
import { idParamSchema, quoteCreateSchema, vendorBookingStatusSchema } from '../validators/common.validators.js';
import { upload } from '../middleware/upload.js';
const router = Router();
router.use(requireAuth, requireRole('vendor'));
router.get('/leads', VendorController.getLeads);
router.post('/leads/:id/reject', validate(idParamSchema), VendorController.rejectLead);
router.get('/quotes', VendorController.getQuotes);
router.post('/quotes', validate(quoteCreateSchema), VendorController.createQuote);
...
router.delete('/buses/:id', validate(idParamSchema), VendorController.deleteBus);
router.get('/bookings', VendorController.getBookings);
router.patch('/bookings/:id/status', validate(vendorBookingStatusSchema), VendorController.updateBookingStatus);
